...
from utils import comma_separator, format_token, hex_to_int, send_discord_notification
...
def process_transaction(tx: Tx):
    ...
    try:
        ...
        if logs is not None:
            log_methods = [log.method for log in logs if log.method]
        else:
            log_methods = []
        ...
        if (
            tx.to_address == "cxa0af3165c08318e988cb30993b3048335b94af6c"
        ):  # Balanced DEX
        ...
        if (
            tx.to_address == "cx66d4d90f5f113eba575bf793570135f9b10cece1"
        ):  # Balanced Loans
